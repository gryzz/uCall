    ...
    handleMessage: function(eventData) {
        ...
        switch(message.t){
            ...
            case this.mappedEvents.EVENT_QUEUE_MEMBER_ADDED:
                ...
                break;
            case this.mappedEvents.EVENT_QUEUE_MEMBER_REMOVED:
                this.fireEvent(uCall.constants.MessageEvent.STATUS_OFFLINE);
                break;
            case this.mappedEvents.EVENT_QUEUE_MEMBER_PAUSED:
                this.fireEvent(uCall.constants.MessageEvent.STATUS_AWAY);
                break;
